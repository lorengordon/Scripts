...
'
' NAME: UDS_UserFolders_Provision_DFS.vbs
'
' AUTHOR: Dan Holme , Intelliem
' DATE  : 11/12/2007
'
' USAGE:  
' cscript.exe UDS_UserFolders_Provision_DFS.vbs UserFolderPath
...
Sub Usage()
		WScript.Echo "UDS_UserFolders_Provision_DFS"
		WScript.Echo "============================="
		WScript.Echo "Create user data stores and"
		WScript.Echo "fully-enumerated DFS namespace for a user."
		WScript.Echo 
		WScript.Echo "USAGE:"
		WScript.Echo "   cscript.exe UDS_UserFolders_Provision_DFS.vbs UserFolderPath"
...
'' SIG '' AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFHCJltygxvtw
'' SIG '' /veZfYEn94jA5KxooIIe4TCCBBIwggL6oAMCAQICDwDB
...
'' SIG '' AQkEMRYEFBnRxbT2iAlhGimp4iF+fgqwRIvZMF4GCisG
...
'' SIG '' DQEBAQUABIIBACfaV5Dn8LY36A9zCiVutmFeRG+dgFSE
'' SIG '' rdRPFOPDEz4pB6gO8uIa63znL/XGf2t96zq5KcK93VgX
'' SIG '' EVVlGXdMHjFfImQxkwVtuk2R5MGJh27hZyovUn5Ct5bE
'' SIG '' n++kN9lZt7AT/VnfFkVmLJtBlYRxA827G4GB93KT8m5A
'' SIG '' BfZ7o58TfXNAYlBQS74fqM8p6jtIQZJO9U6c3d7UcNe+
'' SIG '' qw3qWp80OJsK7Gk3dtBirVwHzjtxdFxqQN5SVk62QZOz
'' SIG '' qwoFx3yOyuqMreR08P4l0dQExaejS9vR7uVC9/MX0NW3
'' SIG '' vmA52esOehjcGMfVgkaKSN2TzkdYDt0tQ/G7LBU/yJ/q
'' SIG '' R2+hggIfMIICGwYJKoZIhvcNAQkGMYICDDCCAggCAQEw
...
'' SIG '' MjAxMTRaMCMGCSqGSIb3DQEJBDEWBBSpnYzl7kKsMtJi
'' SIG '' 6u83KP0NWLXZhTANBgkqhkiG9w0BAQUFAASCAQAt9Mly
'' SIG '' lUqmnepdA0KBvGvR47tkYbCJdIbjSDZ0PuupNVMTUmpo
'' SIG '' C/kohw0+O7E3RfKOy7yks2DDxa5pYuyUUNn7ntMgEBza
'' SIG '' rvTXG+4bqdZ/YygN0mxRFjpOWmi10chktl1VVCS53T0E
'' SIG '' bpnynq+BfVr2y5/XVjM51poFKmxy1usqN8/fsFlLqkP9
'' SIG '' wCJ/im8NyyfECVJAvVoQ/kyEVeRsREwUXOq+g6QTRUir
'' SIG '' FRDEJuHQ0U7TonirMck1z+jyDMPv+BOEadjfoxNoi4t7
'' SIG '' IfdxdhPg/zArPGxrQtcB6nGF4XhvN9WajsprIAINm/Xx
'' SIG '' sVJR6BCNsnGMVh9OaFVlIFEzUpuN
